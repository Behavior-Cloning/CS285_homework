...
def main():
    ...
    parser.add_argument('--do_GAE', action='store_true')
    parser.add_argument('--lam', '-lam', type=float, default=0.96)
    ...
    assert not (params['do_GAE'] == True and params['nn_baseline'] == False)
    if params['do_GAE']:
        print("\nlet's do GAE-lambda!\n")
    ##################################
